...
func (h *Handlers) Create(w http.ResponseWriter, r *http.Request) {
	...
	c, err := h.svc.Create(r.Context(), httpx.UserID(r.Context()), "", body.Name, body.Color)
	if err != nil {
		httpx.WriteError(w, err)
		return
	}
	httpx.WriteJSON(w, http.StatusCreated, httpx.Data(c.DTO()))
}
...
func (h *Handlers) Update(w http.ResponseWriter, r *http.Request) {
	...
	c, err := h.svc.Update(r.Context(), httpx.UserID(r.Context()), chi.URLParam(r, "id"), body.Name, body.Color)
	if err != nil {
		httpx.WriteError(w, err)
		return
	}
	httpx.WriteJSON(w, http.StatusOK, httpx.Data(c.DTO()))
}
